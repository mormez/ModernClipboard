...
<style>
  ...
  body { font-family: -apple-system, "Helvetica Neue", Helvetica, Arial, sans-serif; color: #1a1a1a; font-size: 13px; line-height: 1.4; }
  h1.doc-title { text-align: center; font-size: 22px; margin-top: 0; margin-bottom: 2px; }
  p.doc-subtitle { text-align: center; font-style: italic; color: #666; margin-top: 0; margin-bottom: 14px; }
  h1 { font-size: 18px; margin-top: 16px; margin-bottom: 8px; border-bottom: 2px solid ${BRAND_HEADER_BG}; padding-bottom: 3px; }
  h2 { font-size: 16px; margin-top: 14px; margin-bottom: 6px; color: ${BRAND_HEADER_TEXT}; }
  h3, h4 { font-size: 14px; margin-top: 12px; margin-bottom: 4px; }
  p { margin: 6px 0; }
