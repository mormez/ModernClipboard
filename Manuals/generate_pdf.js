...
<style>
  ...
  body { font-family: -apple-system, "Helvetica Neue", Helvetica, Arial, sans-serif; color: #1a1a1a; font-size: 13px; line-height: 1.5; }
  h1.doc-title { text-align: center; font-size: 26px; margin-bottom: 4px; }
  p.doc-subtitle { text-align: center; font-style: italic; color: #666; margin-top: 0; margin-bottom: 28px; }
  h1 { font-size: 19px; margin-top: 26px; border-bottom: 2px solid ${BRAND_HEADER_BG}; padding-bottom: 4px; }
  h2 { font-size: 16px; margin-top: 20px; color: ${BRAND_HEADER_TEXT}; }
  ...
  blockquote { border-left: 3px solid #999; margin: 10px 0; padding: 4px 14px; color: #444; font-style: italic; }
  a { color: #4640A6; }
